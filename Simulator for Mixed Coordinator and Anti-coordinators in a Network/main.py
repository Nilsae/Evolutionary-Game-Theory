...
def main():
    ...
    network_type = "random_tree"    # topology of social network
    ...
    #             if equilibrable == 0:
    #                 nonables.append (new_res_res)
    #                 # print(new_res_res)
    #
    #             equilibrable =0
    #             if always_equilibrates==1:
    #                 always_eq.append((new_res_res))
    #                 print(new_res_res)
    #             always_equilibrates =1
...
#     nonables.to_csv(f"data/csv/non-equilibrable.scv")
